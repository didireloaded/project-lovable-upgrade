    ...
    <div className={cn("flex items-center gap-2", className)}>
      {items.map((item) => (
        ...
        >
          ...
          {/* Standard <img> — no Next.js dependency */}
          <img
            ...
            width={56}
            height={56}
            className="object-cover object-top rounded-full h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 border-background relative transition duration-500"
          />
        </div>
      ))}
    </div>
