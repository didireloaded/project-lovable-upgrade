...
export function WeatherView() {
  ...
  if (loading) return (
    <div className="flex flex-col h-full">
      <div className="px-4 md:px-6 lg:px-8 pt-6 md:pt-5 pb-3 flex-shrink-0">
        <h2 className="font-display text-[1.4rem] md:text-lg font-bold tracking-[0.08em] uppercase text-primary-foreground">Weather</h2>
      </div>
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 md:px-6 lg:px-8 pt-6 md:pt-5 pb-3 flex-shrink-0 bg-gradient-to-b from-background to-transparent">
        <h2 className="font-display text-[1.4rem] md:text-lg font-bold tracking-[0.08em] uppercase text-primary-foreground">Weather</h2>
        <p className="text-[0.72rem] text-muted-foreground mt-0.5">Real-time driving conditions</p>
      </div>

      <div className="flex-1 overflow-y-auto px-4 md:px-6 lg:px-8 pb-20 md:pb-6 hide-scrollbar">
        {/* Desktop: hero + risk side by side */}
        <div className="flex flex-col md:flex-row gap-3.5 max-w-4xl">
          {/* Hero card */}
          <div className="bg-gradient-to-br from-[hsl(216_50%_18%)] to-[hsl(216_60%_10%)] rounded-[18px] p-5 text-center border border-foreground/[0.08] relative overflow-hidden md:flex-1">
          ...
          {/* Driving risk + Road conditions stacked */}
          <div className="md:w-72 lg:w-80 flex flex-col gap-3.5">
            {/* Driving risk alert */}
            <div className={`border rounded-[14px] px-3.5 py-3 ${risk.bg}`}>
        ...
        <div className="glass-card mt-3.5 max-w-4xl">
